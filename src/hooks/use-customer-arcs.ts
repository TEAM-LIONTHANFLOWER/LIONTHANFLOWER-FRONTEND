...
/**
 * 서버가 내려주는 편지 글은 한 벌뿐입니다.
 *
 * 편지는 직원이 쓴 글이고 서버가 언어별로 나눠 주지 않아서, 다섯 언어에 같은 문장을 넣습니다.
 * 화면이 `LocalizedText` 를 기대하기 때문에 모양만 맞춰 두는 것입니다 —
 * 서버가 번역을 내려주기 시작하면 이 함수가 사라지고 응답을 그대로 쓰게 됩니다.
 */
